...
class ReaderWriter():
    def __init__(self):
        self.rd = threading.Semaphore()  #initializing semaphores using Semaphore class in threading module for reading and wrting                               
    ...
    def main(self):
        t1 = threading.Thread(target = self.reader)         # calling mutliple readers and writers
        t1.start()
